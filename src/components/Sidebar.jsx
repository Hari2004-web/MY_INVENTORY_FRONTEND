...
const ManagerIcon = () => <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015.537 4.097c-.94.54-1.935.896-3.037.995A5.002 5.002 0 011 16v1h6.07z"></path></svg>;
  ...
  return (
    <aside className="w-64 h-full bg-gray-800 flex-shrink-0" aria-label="Sidebar">
      <div className="px-3 py-4 overflow-y-auto">
        <h1 className="text-xl font-bold text-white px-2 py-4">Admin Portal</h1>
        <ul className="space-y-2">
          ...
          {user?.role === 'admin' && (
            <li><NavLink to="/managers" className={({ isActive }) => isActive ? `${linkStyle} ${activeLinkStyle}` : linkStyle}><ManagerIcon />Managers</NavLink></li>
          )}
        </ul>
      </div>
    </aside>
