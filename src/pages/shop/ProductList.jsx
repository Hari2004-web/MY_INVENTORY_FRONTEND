...
// --- Skeleton Card for the dark mode layout ---
const SkeletonCard = () => (
...
// --- Main Shop Page Component with the new style ---
const ProductList = () => {
  ...
  return (
    <div className="bg-[#121212] text-gray-200 font-sans">
      ...
      <header className="bg-black/50 backdrop-blur-lg sticky top-0 z-50 border-b border-gray-800">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8 text-sm font-semibold">
            <a href="#" className="hover:text-[#007CF0] transition-colors">Featured</a>
            <a href="#" className="hover:text-[#007CF0] transition-colors">Technology</a>
            <a href="#" className="hover:text-[#007CF0] transition-colors">Lifestyle</a>
          </nav>
      ...
      {/* ... (Hero, Main, and Footer sections remain the same) ... */}
      ...
      <footer className="bg-black/50 border-t border-gray-800 mt-16">
        <div className="container mx-auto px-6 py-8 text-center">
            ...
            <div className="mt-6 space-x-8 text-gray-400">
