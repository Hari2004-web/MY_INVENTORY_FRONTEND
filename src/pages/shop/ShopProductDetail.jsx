// src/pages/shop/ShopProductDetail.jsx
...
const ShopProductDetail = () => {
  ...
  return (
    <div className="bg-[#121212] text-white min-h-screen font-sans p-4 sm:p-8">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 bg-[#1A1A1A] p-8 rounded-2xl shadow-lg">
          {/* Image Column */}
          <div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto pt-8">
              <button
                ...
                className="w-full py-4 px-6 bg-[#007CF0] text-white font-bold rounded-lg shadow-lg hover:bg-blue-600 transition-all duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed"
              >
